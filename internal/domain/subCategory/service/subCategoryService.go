...
type SubCategoryService interface {
	GetOneSubCategory(categoryID, subCategoryID int) (*dto.GetOneSubCategoryResponse, error)
	GetAllSubCategory(categoryID int) ([]dto.GetAllSubCategoryResponse, error)
